// fork from Metamask https://github.com/MetaMask/metamask-extension/blob/develop/app/scripts/platforms/extension.js
import extension from 'extensionizer';
import { getBlockExplorerLink } from '@metamask/etherscan-link';
import { getEnvironmentType, checkForError } from '../utils/lib-util';
...
class ExtensionPlatform {
  ...
  openWindow(options): Promise<any> {
    return new Promise((resolve, reject) => {
  ...
  focusWindow(windowId): Promise<void> {
    return new Promise((resolve, reject) => {
  ...
  updateWindowPosition(windowId, left, top): Promise<void> {
    return new Promise((resolve, reject) => {
