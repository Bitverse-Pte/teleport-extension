...
interface GetMaximumGasTotalInHexWeiInputType {
  gasLimit?: string;
  gasPrice?: string;
  maxFeePerGas?: string;
}
...
export function getMaximumGasTotalInHexWei({
  ...
  gasPrice,
  maxFeePerGas,
}: GetMaximumGasTotalInHexWeiInputType = {}): string {
  if (maxFeePerGas) {
    return addHexPrefix(
...
interface GetMinimumGasTotalInHexWeiInputType {
  gasLimit?: string;
  gasPrice?: string;
...
export function getMinimumGasTotalInHexWei({
  ...
  maxFeePerGas,
  baseFeePerGas,
}: GetMinimumGasTotalInHexWeiInputType = {}) {
