...
export const DEFAULT_TOKEN_CONFIG: Token[] = [
  ...
  },
  {
    ...
    isNative: false,
    isCustom: false,
    contractAddress: '0xD2af830E8CBdFed6CC11Bab697bB25496ed6FA62',
    display: true,
  },
  {
    symbol: 'OGV',
  ...
  },
  {
    ...
    isNative: false,
    isCustom: false,
    contractAddress: '0x0c4576ca1c365868e162554af8e385dc3e7c66d9',
    display: true,
  },
  {
    symbol: 'OGN',
  ...
  },
  {
    ...
    name: 'OSMOSIS',
    denom: 'uosmo',
    icon: 'https://raw.githubusercontent.com/trustwallet/assets/master/blockchains/osmosis/info/logo.png',
