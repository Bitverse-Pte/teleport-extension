...
const webWorker = new Worker(new URL('../workers/worker.ts', import.meta.url));
...
//     const result = await httpClient.post1(apiUrl1, {
//       activityId: '123456',
//     },
//     // 不传默认是生产环境地址
//     {
...
// const result = await httpClient.post1(
//   apiUrl1,
//   {
//     activityId: '123456',
//   },
    ...
    post1: async (url, args) => {
      const response = await fetch(url, {
        ...
        headers: {
          'Content-Type': 'application/json',
          userToken:
            'eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NiJ9.eyJhcHBJZCI6ImJpdHZlcnNlX2FwcCIsInVzZXJJZCI6MjA4ODU3MDAwMDAxMDAxNiwicGxhdGZvcm0iOjEsImlzc3VlZF9hdCI6MTY4NTE3NzgxNzE3NSwiZ2VuX3RzIjoxNjg1MjY0MjE3MTc1LCJleHBpcmVzX2F0IjoxNjg3NzY5ODE3MTc1LCJpYXQiOjE2ODUxNzc4MTcsImV4cCI6MTY4Nzg1NjIxN30.MEUCICDQtDguxljVG4i4OhSwwOeldEraIm045vf9J1jaYr7lAiEA164xmnOgryQJyIJw_nlS8xOZLSSgSBx71LzyO_EZB0k',
        },
...
//   /// keygen first
//   const kg_party_one_first_message_result = await instance.post1(
...
//   ///// keygen second
//   const kg_party_one_second_message_result = await instance.post1(
...
//   ///// chain_code first
//   const cc_party_one_first_message_result = await instance.post1(
...
//   ///// chain_code second
//   const cc_party_one_second_message_result = await instance.post1(
...
//   const sign_party_one_first_message_result = await instance.post1(
...
//   const sign_party_one_second_message_result = await instance.post1(
